...
public class LoginGUI extends JFrame implements ActionListener{
	...
	public LoginGUI() {
		//System.out.println("构造方法LoginGUI()");
		init();
	...
	public void actionPerformed(ActionEvent e) {
		System.out.println("LoginGUI actionPerformed(ActionEvent e)");
	...
	private void init() {
		System.out.println("进入LoginGUI init()");
		this.setTitle("登陆界面");
		...
		System.out.println("登录按钮添加监听器loginBtn.addActionListener(this)");
		...
		//System.out.println("初始化界面完毕");
	}

	// 设置中间面板
	private JPanel getCenterPanel() {
		System.out.println("进入getCenterPanel()");
...
//		String address = localhost.getHostAddress();
	...
	private JPanel getWestPanel() {
		System.out.println("进入getWestPanel()");
	...
	private JPanel getEastPanel() {
		System.out.println("进入getEastPanel()");
	...
	private JPanel getSouthPanel() {
		System.out.println("进入getSouthPanel()");
	...
	private JPanel getNorthPanel() {
		System.out.println("进入getNorthPanel()");
