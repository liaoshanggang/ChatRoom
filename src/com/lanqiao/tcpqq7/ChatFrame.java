...
public class ChatFrame extends JFrame implements ActionListener {
	...
	public void getSocket() {
		...
		try {
			...
			out.println(ChatUtil.FRIEND_LIST);// 好友列表标识符1008611
			out.flush();// 刷新
			out.println(u.getName() + ":" + u.getSex());// 张三:性别
			out.flush();// 刷新

			out.println(ChatUtil.OPEN_ROOM);// 进入聊天室标识符10086
			out.flush();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("发送")) {
			try {
				...
				/*
				 * //异常提示框 JOptionPane.showMessageDialog(this, "发送异常", "发送提醒",
		...
		if (e.getActionCommand().equals("刷新")) {
			try {
				...
				/*
				 * JOptionPane.showMessageDialog(this, "刷新异常", "刷新提醒",
				 * JOptionPane.INFORMATION_MESSAGE);
				 */
				e1.printStackTrace();
			}
